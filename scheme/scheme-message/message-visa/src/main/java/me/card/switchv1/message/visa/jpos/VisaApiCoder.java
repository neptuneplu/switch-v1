...
import me.card.switchv1.api.visa.F3;
import me.card.switchv1.api.visa.F55;
import me.card.switchv1.api.visa.TagValue;
...
public class VisaApiCoder implements ApiCoder<VisaApi, VisaMessageByJpos> {
  ...
  private void decodeSpecialField(
      VisaMessageByJpos visaMessage, VisaApi visaApi) {
  ...
  private void encodeSpecialField(
      VisaMessageByJpos visaMessage, VisaApi visaApi) {
  ...
  @Override
  public VisaMessageByJpos errorMessage(
